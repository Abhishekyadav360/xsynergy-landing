            ...
            <section className="relative bg-cover bg-center bg-no-repeat py-36 sm:py-52 overflow-hidden">
                ...
                <div className="flex items-center relative justify-center container px-2 sm:px-4 mx-auto mt-5">
                    ...
                    <div className="text-center relative max-w-7xl mx-auto w-full mt-5" data-aos="fade-up">
                        ...
                        <div className="flex items-center justify-center gap-0 sm:gap-4 border-[1px] border-[#baf8cc2f] bg-[#0d0d0d] rounded-full px-1 py-[5px] max-w-64 sm:max-w-[370px] w-full mx-auto  overflow-hidden">
                            {/* Left Decorative SVG */}
                        ...
                        <h1 className="text-5xl md:text-[90px] font-bold mb-3 sm:mb-3 leading-tight sm:leading-none max-w-4xl mx-auto">
                           ...
                           <MatrixText key={(typeof window !== 'undefined' && window.performance.now()) || 1} text="XSynergy" speed={150} />
