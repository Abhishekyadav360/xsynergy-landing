...
const Footer = () => {
    ...
    return (
        <footer className="text-white  py-10 footermain top-full sticky   ftr-bg overflow-hidden border-t border-green-400/20 ">
                ...
                <div className="">
                    ...
                    <div className="flex space-x-5 mx-auto items-center justify-center mt-5" >
                        <Link className="   p-2 rounded-3xl   " href="/" target="_blank" rel="noopener noreferrer">
                            <Image src={facebook} alt='facebook' width={100} height={100} className='w-12 h-12 hover:-rotate-[25deg]  transition-transform duration-300 ease-in-out' />
                        </Link>
                        <Link className="  p-2  " href="/" target="_blank" rel="noopener noreferrer">
                            <Image src={instagram} alt='instagram' width={100} height={100} className='w-12 h-12 hover:-rotate-[25deg]  transition-transform duration-300 ease-in-out' />
                        </Link>
                        <Link className="  p-2 rounded-3xl  " href="/" target="_blank" rel="noopener noreferrer">
                            <Image src={telegram} alt='telegram' width={100} height={100} className='w-12 h-12 hover:-rotate-[25deg]  transition-transform duration-300 ease-in-out' />
                        </Link>
                        <Link className="  p-[10px] rounded-3xl  " href="/" target="_blank" rel="noopener noreferrer">
                            <Image src={youtube} alt='youtube' width={100} height={120} className='w-12 h-12 hover:-rotate-[25deg]  transition-transform duration-300 ease-in-out ' />
                        </Link>
