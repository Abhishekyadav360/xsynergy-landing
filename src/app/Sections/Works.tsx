...
// ✅ Now these variants use "custom" to switch based on device
const cardVariants = {
  hiddenLeft: (isMobile: boolean) =>
    isMobile ? { opacity: 0, y: 120 } : { opacity: 0, x: -300 },
  hiddenRight: (isMobile: boolean) =>
    isMobile ? { opacity: 0, y: 120 } : { opacity: 0, x: 300 },
              ...
              <svg width="108" height="20" viewBox="0 0 108 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                  ...
                  <filter id="green-glow" x="-50%" y="-50%" width="200%" height="200%">
                    <feDropShadow dx="0" dy="0" stdDeviation="4.5" flood-color="#00FF7F" flood-opacity="1" />
                  </filter>
                </defs>
              </svg>
            </div>
