...
const services = [
  {
    ...
    desc: 'Your funds are governed by immutable code — zero human intervention, zero backdoors, zero risk of admin errors',
    img: '/ecosystem.webp',
    arrow: '→',
  },
  {
    ...
    desc: 'All transactions, payouts, and vault actions live on-chain — publicly auditable by anyone, anytime',
    img: '/whyx6.webp',
    arrow: '↗',
  },  
  {
    ...
    desc: '10% of every inflow locks into a Solana reserve, creating a built-in price floor and rock-solid foundation.',
    img: '/whyx5.webp',
    arrow: '↗',
  },
  {
    id: '04',
    title: 'Utility-First Token',
    desc: '$XSYN isn’t just a symbol—it’s your key to mine time, stake vaults, and unlock exclusive features.',
    img: '/whyx3.webp',
    arrow: '↗',
  },
  {
    ...
    desc: 'Join thousands worldwide who are escaping the status quo—earning daily, building wealth, and reshaping finance.',
    img: '/globalx.webp',
    arrow: '↗',
  },
];
